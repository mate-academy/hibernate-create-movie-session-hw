...
public class MovieSessionDaoImpl implements MovieSessionDao {
    ...
    public List<MovieSession> findAvailableSessions(Long movieId, LocalDate date) {
        LocalDateTime startOfADay = date.atTime(LocalTime.MIN);
        LocalDateTime endOfADay = date.atTime(LocalTime.MAX);
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            getAllMovieSessionsQuery.setParameter("min", startOfADay);
            getAllMovieSessionsQuery.setParameter("max", endOfADay);
