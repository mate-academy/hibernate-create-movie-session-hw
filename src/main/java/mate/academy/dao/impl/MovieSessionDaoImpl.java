    ...
    public List<MovieSession> findAvailableSessions(Long movieId, LocalDate date) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<MovieSession> getMovieSession = session.createQuery(
                    ...
                    + "and localDateTime between :startOfTheDay and :endOfTheDay",
                    MovieSession.class);
            getMovieSession.setParameter("movie_id", movieId);
            ...
            getMovieSession.setParameter("startOfTheDay", startOfTheDay);
            getMovieSession.setParameter("endOfTheDay", endOfTheDay);
