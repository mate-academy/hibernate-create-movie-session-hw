...
public class MovieSessionDaoImpl implements MovieSessionDao {
    ...
    public List<MovieSession> findAvailableSessions(Long movieId, LocalDate date) {
        ...
        try (Session session = sessionFactory.openSession()) {
            Query<MovieSession> getMovieSessionsQuery = session.createQuery(
            ...
            getMovieSessionsQuery.setParameter("startDate", LocalDateTime.of(date, LocalTime.MIN));
            getMovieSessionsQuery.setParameter("endDate", LocalDateTime.of(date, LocalTime.MAX));
