...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        largeCinemaHall.setCapacity(4000);
        largeCinemaHall.setDescription("Large hall capacity 4000");
        CinemaHallService cinemaHallService
                = (CinemaHallService) injector.getInstance(CinemaHallService.class);
        cinemaHallService.add(largeCinemaHall);
        cinemaHallService.get(largeCinemaHall.getId());

        MovieSession movieSession = new MovieSession();
        movieSession.setMovie(fastAndFurious);
        movieSession.setCinemaHall(largeCinemaHall);
