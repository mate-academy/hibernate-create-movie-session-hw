...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CinemaHall firstCinemaHall = new CinemaHall(34, "Nice");
        CinemaHall secondCinemaHall = new CinemaHall(28, "Very nice");
        cinemaHallService.add(firstCinemaHall);
        cinemaHallService.add(secondCinemaHall);
        System.out.println(cinemaHallService.get(1L));
        cinemaHallService.getAll().forEach(System.out::println);

        LocalDateTime firstMovieSessionDate = LocalDateTime.of(2001, 6, 20, 12,2);
        LocalDateTime secondMovieSessionDate = LocalDateTime.of(2023, 5, 12, 2,34);
        ...
        movieSessionService.findAvailableSessions(secondMovieSession.getMovie().getId(),
                LocalDate.of(2023, 5, 12)).forEach(System.out::println);
    }
}
