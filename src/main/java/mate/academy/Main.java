...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        imaxHall.setDescription("The best ever hall with Laser iMax 3D technology");
        ...
        nightMovieSession.setCinemaHall(imaxHall);
        nightMovieSession.setShowTime(LocalDateTime.now());
        ...
        movieSessionService.findAvailableSessions(nightMovieSession.getId(), LocalDate.now())
