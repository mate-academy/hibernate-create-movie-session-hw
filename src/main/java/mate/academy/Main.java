...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CinemaHall cinemaHall = new CinemaHall(1000, "IMAX");
        ...
        movieSessionTenOClock.setShowTime(LocalDateTime.of(2023, 8, 24, 10, 0));
        ...
        movieSessionTwelveOClock.setShowTime(LocalDateTime.of(2023, 8, 24, 12, 0));
        ...
        movieSessionTwoOClock.setShowTime(LocalDateTime.of(2023, 8, 24, 14, 0));
        ...
        movieSessionAnotherDay.setShowTime(LocalDateTime.of(2023, 9, 1, 14, 0));
        movieSessionService.add(movieSessionAnotherDay);

        movieSessionService.findAvailableSessions(
                fastAndFurious.getId(), LocalDate.of(2023, 8, 24))
