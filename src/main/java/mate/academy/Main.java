...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CinemaHall hugeHall = new CinemaHall();
        hugeHall.setCapacity(400);
        hugeHall.setDescription("Huge cinema hall");
        cinemaHallService.add(hugeHall);
        System.out.println(cinemaHallService.get(hugeHall.getId()));
        ...
        movieSession.setCinemaHall(hugeHall);
