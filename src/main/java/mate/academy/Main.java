...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        morningSession.setCinemaHall(hall1);
        morningSession.setShowTime(LocalDateTime.of(2023, 4, 18, 10, 0));
        movieSessionService.add(morningSession);
        System.out.println(movieSessionService.get(morningSession.getId()));
        movieSessionService.findAvailableSessions(fastAndFurious.getId(), LocalDate.of(2023, 4, 18))
