...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        morningMovieSession.setLocalDateTime(LocalDateTime
                .of(2020, 10, 15, 10, 0));
        ...
        dayMovieSession.setLocalDateTime(LocalDateTime
                .of(2020, 10, 15, 12, 0));
        ...
        afternoonMovieSession.setLocalDateTime(LocalDateTime
                .of(2020, 11, 24, 14, 0));
        ...
        eveningMovieSession.setLocalDateTime(LocalDateTime
                .of(2020, 12, 3, 20, 0));
        ...
        nightMovieSession.setLocalDateTime(LocalDateTime
                .of(2020, 10, 15, 23, 0));
