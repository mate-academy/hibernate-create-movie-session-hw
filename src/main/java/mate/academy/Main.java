...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        LocalDateTime firstMovieSessionDate = LocalDateTime.of(2023, 6, 20, 15,30);
        LocalDateTime secondMovieSessionDate = LocalDateTime.of(2024, 6, 20, 15,30);
        ...
        movieSessionService.findAvailableSessions(secondMovieSession.getMovie().getId(),
                LocalDate.of(2024, 6, 20)).forEach(System.out::println);
    }
}
