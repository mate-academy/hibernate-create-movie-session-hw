...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CinemaHall grandHall = new CinemaHall();
        grandHall.setDescription("Grand hall");
        grandHall.setCapacity(500);
        cinemaHallService.add(grandHall);
        System.out.println(cinemaHallService.get(grandHall.getId()));
        ...
        firstSession.setCinemaHall(grandHall);
