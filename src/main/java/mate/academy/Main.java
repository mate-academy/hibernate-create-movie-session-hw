...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        terminator.setDescription("film about robots");
        ...
        greenHall.setCapacity(150);
        greenHall.setDescription("Green");
        ...
        firstSession.setShowTime(LocalDateTime.of(2022, 11, 07, 19,00));
        ...
        secondSession.setMovie(terminator);
        secondSession.setShowTime(LocalDateTime.of(2022, 11, 07, 21, 00));
