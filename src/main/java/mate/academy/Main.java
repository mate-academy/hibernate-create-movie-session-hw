...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CinemaHall cinemaHall = new CinemaHall(120, "description");
        ...
        MovieSession movieSessionNow = new
                MovieSession(LocalDateTime.now(), fastAndFurious, cinemaHall);
        ...
        MovieSession movieSessionOld = new MovieSession(
                LocalDateTime.of(2000, 1, 1, 0, 0, 0), fastAndFurious, cinemaHall);
        movieSessionService.add(movieSessionOld);
        MovieSession movieSessionLater =
                new MovieSession(LocalDateTime.now().plusHours(1), fastAndFurious, cinemaHall);
        movieSessionService.add(movieSessionLater);
        MovieSession movieSessionEarlier =
                new MovieSession(LocalDateTime.now().minusHours(1), fastAndFurious, cinemaHall);
