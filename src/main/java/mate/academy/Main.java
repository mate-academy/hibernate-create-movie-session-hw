...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CinemaHall fastAndFuriousInLargeHall = new CinemaHall(15, "Family");
        cinemaHallService.add(fastAndFuriousInLargeHall);

        MovieSessionService movieSessionService =
                (MovieSessionService) injector.getInstance(MovieSessionService.class);

        MovieSession firstSessionFastAndFurious =
                new MovieSession(fastAndFurious, fastAndFuriousInLargeHall,
                LocalDateTime.now());
