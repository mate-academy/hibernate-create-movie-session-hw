...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CinemaHall firstCinemaHall = new CinemaHall(50, "Vip Cinema Hall");
        CinemaHall secondCinemaHall = new CinemaHall(200, "Standard Cinema Hall");
        cinemaHallService.add(firstCinemaHall);
        cinemaHallService.add(secondCinemaHall);
        System.out.println(cinemaHallService.get(1L));
        cinemaHallService.getAll().forEach(System.out::println);

        LocalDateTime firstMovieSessionDate = LocalDateTime.of(2023, 7, 7, 13,10);
        LocalDateTime secondMovieSessionDate = LocalDateTime.of(2024, 7, 7, 13,10);
        ...
        movieSessionService.findAvailableSessions(secondMovieSession.getMovie().getId(),
                LocalDate.of(2024, 7, 7)).forEach(System.out::println);
    }
}
