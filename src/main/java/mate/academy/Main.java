...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        greenHall.setDescription("Green Cinema 3D Hall");
        ...
        LocalDateTime localDateTime = LocalDateTime.of(2023, 4, 16, 16, 16);
        movieSession.setShowtime(localDateTime);
        movieSessionService.add(movieSession);
        System.out.println(movieSessionService.get(movieSession.getId()));
        LocalDate movieDate = localDateTime.toLocalDate();
        movieSessionService
                .findAvailableSessions(fastAndFurious.getId(), movieDate)
