...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        movieSession.setShowTime(LocalDateTime.of(2021, 10, 26,
                21, 0));
        movieSessionService.add(movieSession);
        movieSessionService.get(1L);
        List<MovieSession> movieSessionsByDate = movieSessionService
                .findAvailableSessions(1L,
                        LocalDate.of(2021, 10, 26));
        movieSessionsByDate.forEach(System.out::println);
    }
}
