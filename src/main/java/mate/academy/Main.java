...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        redCinemaHall.setDescription("Comfortable cinema hall for real men.");
        ...
        testMovieSession.setCinemaHall(redCinemaHall);
        testMovieSession.setMovie(fastAndFurious);
        testMovieSession.setShowTime(LocalDateTime.of(2022, 7, 22, 21, 00));

        MovieSessionService movieSessionService
                = (MovieSessionService) injector.getInstance(MovieSessionService.class);
        movieSessionService.add(testMovieSession);
        movieSessionService.get(testMovieSession.getId());
