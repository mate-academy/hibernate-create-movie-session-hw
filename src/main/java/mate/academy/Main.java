...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Movie fastAndFurious = new Movie("Forest Gump");
        fastAndFurious.setDescription("Philosophy, drama");
        movieService.add(fastAndFurious);
        Movie avatar = new Movie("Terminator");
        avatar.setDescription("Staring Arny");
